...
- **Open:** book = pages in this document or its own file pulling from the Library; Chris's surname (Unrue/Unruh) and pronouns conflict across records; merge order against the Georgeland Editor branch (both touch this file).
