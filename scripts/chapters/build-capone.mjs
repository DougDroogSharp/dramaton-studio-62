...
const scenes = [
  ...
  // 0a — muscle: the historical election-day takeover, and its bill.
  {
    ...
    script: lines(
      ...
      'Narrator: "Some two hundred armed men worked the polls all day — ballots inspected, election judges driven off, poll watchers escorted out of town. Cicero voted the Outfit\'s way. The Crime Commission\'s Virgil Peterson would file it as one of the most disgraceful episodes in American municipal history. By evening the family had a bill of its own: Al\'s brother Frank, dead in a volley from plainclothes police outside a polling place."',
  ...
  // 2 — THE GARAGE AFTERMATH: the wall and the silence.
  {
    ...
    script: lines(
      ...
      '[ENDIF]',
      'Narrator: "The Chicago Crime Commission answered with a new kind of list. April 24, 1930: twenty-eight names, published for the papers — and at the top, number one, Al Capone. The publicity that built him began to turn."',
  ...
  // 4 — WILSON'S OFFICE: the ledgers close in.
  {
    ...
    script: lines(
      ...
      '[/TICK]',
      '',
      'Narrator: "October 18, 1928: on Elmer Irey\'s desk at the Treasury Intelligence Unit, a file opens. From it, 1929 to 1931, Special Agent Frank J. Wilson works under death threats, tracing a fortune that was never supposed to leave a mark — a syndicate the Crime Commission reckoned at sixty million dollars a year in net profits. In 1927 the Supreme Court ruled that even illegal income is taxable. Capone has never filed a return."',
      poseCmd('st_wilson', 'wilson', 'Closeup', 'Determined'),
      'Wilson: "A seized ledger from the Hawthorne Smoke Shop. Net profits, initialed. Cashier\'s checks endorsed by his men. And two bookkeepers — Shumway, Reis — who kept those columns and can read them to a jury, if we can keep them alive. He never opened a bank account in his life — and it doesn\'t matter. A net worth is a confession written in arithmetic."',
  ...
  // 5b — the straight play.
  {
    ...
    script: lines(
      ...
      'Narrator: "The lawyers tried the deal first — a negotiated plea, two and a half years. Wilkerson threw it out from the bench, on the record: it is utterly impossible to bargain with a Federal court. The trial would be real, in front of whatever twelve citizens fate seated."',
  ...
  // 7a — ENDING: high heat. The government makes an example.
  {
    ...
    script: lines(
      ...GAUGES,
      'Narrator: "October 24, 1931: eleven years, a $50,000 fine, $215,000 in back taxes — the stiffest tax sentence to date, because the government wanted the loudest man in America to fall loudly. Your HEAT saw to that: every headline, every retaliation, every bought juror was an exhibit."',
...
const REVENTS = [
  ...
  { id: 'enemy', name: 'Public Enemy No. 1', sign: 'PUBLIC ENEMY NUMBER ONE — 1930',
    dropId: dropLexington,
    intro: 'April 24, 1930. The Chicago Crime Commission publishes its list — twenty-eight names, Capone at number one. The publicity that built him begins to turn. Who speaks?',
...
const EXPANSION = [
  ...
  xw('capa_soup_work_3', 'The Soup, Years Later — the Workman', dropSoup,
    ...
    [
      'Narrator: "The kitchen closed in April 1932 — the man in prison, the associates unsentimental, and unemployment still climbing when the doors shut. The soup had never been for the hunger; the hunger had merely coincided with the need. The churches took the line back, at church portions."',
